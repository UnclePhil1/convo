'use client'
import { KeyboardArrowDownOutlined, FileOpenOutlined, PeopleAltOutlined } from '@mui/icons-material';
import Image from 'next/image';
import React, { useState } from 'react'

const DropboxFiles:React.FC = () => {
    ...
    return (
        <div className='w-[100%] flex flex-col justify-center items-center rounded-[20px] bg-green-100'>
            <div className='w-[100%] flex flex-row gap-4 justify-evenly items-center px-2 py-4'>
                <FileOpenOutlined className='text-yellow-500 text-[25px] bg-slate-50 p-1 rounded-full' />
                <button type='button' onClick={handleToggle} className='text-[14px]'>Files & Docs (6)</button>
